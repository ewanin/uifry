...
const ReadyContent = () => {
  ...
  return (
    <div className='flex flex-col gap-4 ml-20 w-[550px]'>
          <h1 className='text-[48px] leading-[48px] text-white capitalize'>{title}</h1>
